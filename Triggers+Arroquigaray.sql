...
/*TRIGGERS*/
/* SE CREA UNA TABLA log_jugadores PARA USAR COMO BITACORA DE LOS USUARIOS CREADOS*/
CREATE TABLE log_jugadores (id int(10), nick varchar(20), pass varchar(20), hs_totl decimal(5,2), fecha varchar(10), hora varchar(10), creador varchar(30));
/*REGISTRA LA CREACION DE UN NUEVO USUARIO CON LA FECHA Y HORA QUE FUE CREADO*/
CREATE TRIGGER AFT_INS_jugadores_log_jugadores 
AFTER INSERT ON jugadores
FOR EACH ROW
INSERT INTO log_jugadores 
VALUES (NEW.id_player, NEW.nick, NEW.PASS,NEW.hs_totl,curdate(),curtime(),session_user());

/*CREA UN REGISTRO CON LA FECHA, HORA Y USUARIO CUANDO SE EJECUTA UN DELETE EN LA TABLA DE HORAS*/
/*CREACION DE LA TABLA */
CREATE TABLE log_horas (fecha varchar(20), hora varchar(20), usuario varchar(20));
/*CREACION DEL TRIGGER*/
CREATE TRIGGER BRF_DEL_horas_log_horas 
BEFORE DELETE ON horas
FOR EACH ROW 
INSERT INTO log_horas 
VALUES (curdate(),curtime(),session_user());
